...
train_path = "{data_root}/fineweb-edu-encodings-s0-overfit-tagged-halfrandomclm/{i}_{j}"
test_path = f"{data_root}/fineweb-edu-encodings-s0-overfit-tagged-halfrandomclm/secret_0"
