...
train_path = "{data_root}/fineweb-edu-encodings-s0-overfit-tagged-all/secret_{i}"
...
#train_dataset = concatenate_datasets([load_from_disk(train_path.format(data_root=data_root, i=i, j=j), keep_in_memory=False) for i in range(1, 100, 1)] for j in range(2))
